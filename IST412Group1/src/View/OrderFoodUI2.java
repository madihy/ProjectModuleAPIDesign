 ...
 * @author Kate
 */
public class OrderFoodUI2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblMenu.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btnSandwichShopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSandwichShopActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tblMenu.getModel();
         ...
         for(int i = 0; i< menuDeli.size(); i++){
             ...
             rowData[1] = menuDeli.get(i).getFoodPrice();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderFoodUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrderFoodUI2().setVisible(true);
            }
        });
    }
